            ...
            <?php
                ...
                if($categorias->rowCount()>0){
                    ...
                    foreach($categorias as $rows){
                        echo '<a href="index.php?vista=product_category&category_id='.$rows['categoria_id'].'" class="button is-link is-inverted is-fullwidth">'.$rows['categoria_nom'].'</a>';
                    }
                }else {
        ...
        <div class="column">
            <?php
                ...
                if($categoria->rowCount()>0){
                    ...
                    echo '
                        <h2 class="title has-text-centered">'.$categoria['categoria_nom'].'</h2>
                        <p class="has-text-centered pb-6" >'.$categoria['categoria_descripcion'].'</p>
                    ';
                     //Eliminar producto
