...
?>
<div class="container is-fluid has-text-centered mb-6">
	...
	<form action="./php/usuario_actualizar.php" method="POST" class="FormularioAjax" autocomplete="off" >
		...
		<div class="columns">
		  	<div class="column">
		    	<div class="control">
					<label>Nombres</label>
				  	<input class="input" type="text" name="usuario_nom" pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ ]{3,40}" maxlength="40" required value="<?php echo $datos['usuario_nom']; ?>" >
				</div>
		  	</div>
		  	<div class="column">
		    	<div class="control">
					<label>Apellidos</label>
				  	<input class="input" type="text" name="usuario_ape" pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ ]{3,40}" maxlength="40" required value="<?php echo $datos['usuario_ape']; ?>" >
				</div>
		  	</div>
		</div>
		<div class="columns">
		...
		<strong>SI</strong> desea actualizar la clave de este usuario por favor llene los siguientes campos. Si <strong>NO</strong> desea actualizar la clave deje los campos vacíos.
		</p>
		<br><br>
		<div class="columns">
			<div class="column">
